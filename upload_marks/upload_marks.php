...
<head>
    ...
    <script>
        ...
        function success() {
            ...
            $("#success_msg_div").html("<strong>Success!</strong>  Marks Uploaded " );
...
<div class="container">
    <div class="row-fluid">
        <label class="heading">Upload Board Marks</label>
    ...
    <div class="alert alert-success" style="margin-top: 1%" id="success_div">
        <div id="success_msg_div" style="text-align: center">
